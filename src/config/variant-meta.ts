...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  'fx-7ccy': {
    title: 'FX Monitor - 7 Currency Dashboard (NZD/CHF/GBP/USD/JPY/EUR/CAD)',
    description: 'FX analysis dashboard focused on 7 major currencies: NZD, CHF, GBP, USD, JPY, EUR, CAD. Policy rates, economic calendar, COT positioning, and forex intelligence.',
    keywords: 'forex dashboard, FX analysis, currency dashboard, NZD, CHF, GBP, USD, JPY, EUR, CAD, policy rates, COT positioning, economic calendar, central banks, forex trading',
    url: 'https://www.worldmonitor.app/',
    siteName: 'FX Monitor',
    shortName: 'FXMonitor',
    subject: 'FX Analysis for 7 Major Currencies',
    classification: 'FX Dashboard, Forex Intelligence, Currency Analysis',
    categories: ['finance', 'trading'],
    features: [
      'Policy rate comparison (7 currencies)',
      '7-currency economic calendar with filters',
      'COT positioning (Asset Manager & Leveraged Funds)',
      'Central bank mapping',
      'FX news aggregation per currency',
      'Yield curve comparison (US & ECB)',
      'Market radar signals',
    ],
  },
};
